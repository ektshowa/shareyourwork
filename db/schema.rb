...
ActiveRecord::Schema.define(version: 20141218044028) do

  create_table "articlefiles", force: true do |t|
    t.string   "filename"
    t.string   "filetype"
    t.binary   "filecontents", limit: 16777215
  ...
  create_table "commentmicroposts", force: true do |t|
    t.string   "content"
    t.integer  "user_id"
  ...
  add_index "commentmicroposts", ["article_id"], name: "index_commentmicroposts_on_article_id", using: :btree
